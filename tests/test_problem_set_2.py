...
class Tests:
    ...
    def test_over_90(self, capsys, monkeypatch):
        ...
        cases = [
            # temp                      #aircon
            {
                "inputs": [str(random.randint(91, 134)), "yes"],
                "expected": "Stay cool indoors.",
            },
            {
                "inputs": [str(random.randint(91, 134)), "yes"],
                "expected": "Stay cool indoors.",
            ...
            {
                "inputs": [str(random.randint(91, 134)), "no"],
                "expected": "I hope you have a fan.",
            },
            {
                "inputs": [str(random.randint(91, 134)), "no"],
                "expected": "I hope you have a fan.",
    ...
    def test_under_40(self, capsys, monkeypatch):
        ...
        cases = [
            # temp                      #snow   #jacket
            {
                "inputs": [str(random.randint(-70, 39)), "yes", "yes"],
                "expected": "Glad to hear you're dressed appropriately!",
            },
            {
                "inputs": [str(random.randint(-70, 39)), "yes", "yes"],
                "expected": "Glad to hear you're dressed appropriately!",
            ...
            {
                "inputs": [str(random.randint(-70, 39)), "yes", "no"],
                "expected": "What were you thinking when you left home today?!",
            },
            {
                "inputs": [str(random.randint(-70, 39)), "yes", "no"],
                "expected": "What were you thinking when you left home today?!",
    ...
    def test_cold_rain(self, capsys, monkeypatch):
        ...
        cases = [
            ...
            {
                "inputs": [str(random.randint(-70, 39)), "no", "yes", "yes"],
                "expected": "Good job staying dry!",
            },
            {
                "inputs": [str(random.randint(-70, 39)), "no", "yes", "yes"],
                "expected": "Good job staying dry!",
            ...
            {
                "inputs": [str(random.randint(-70, 39)), "no", "yes", "no"],
                "expected": "You must enjoy getting wet!",
            },
            {
                "inputs": [str(random.randint(-70, 39)), "no", "yes", "no"],
                "expected": "You must enjoy getting wet!",
    ...
    def test_affirmatives(self, capsys, monkeypatch):
        ...
        cases = [
            ...
            {
                "inputs": [str(random.randint(-70, 39)), "no", "yeah", "yeah"],
                "expected": "Good job staying dry!",
            },
            {
                "inputs": [str(random.randint(-70, 39)), "no", "yup", "yup"],
                "expected": "Good job staying dry!",
            },
            {
                "inputs": [str(random.randint(-70, 39)), "yes", "yes"],
            ...
            {
                "inputs": [str(random.randint(-70, 39)), "yeah", "yeah"],
                "expected": "Glad to hear you're dressed appropriately!",
            },
            {
                "inputs": [str(random.randint(-70, 39)), "yup", "yup"],
                "expected": "Glad to hear you're dressed appropriately!",
            },
        ]
    ...
    def test_negatives(self, capsys, monkeypatch):
        ...
        cases = [
            ...
            {
                "inputs": [str(random.randint(91, 134)), "nah"],
                "expected": "I hope you have a fan.",
            },
            {
                "inputs": [str(random.randint(91, 134)), "nope"],
                "expected": "I hope you have a fan.",
            },
            {
                "inputs": [str(random.randint(-70, 39)), "yes", "no"],
            ...
            {
                "inputs": [str(random.randint(-70, 39)), "yes", "nah"],
                "expected": "What were you thinking when you left home today?!",
            },
            {
                "inputs": [str(random.randint(-70, 39)), "yes", "nope"],
                "expected": "What were you thinking when you left home today?!",
            },
            {
                "inputs": [str(random.randint(-70, 39)), "no", "yes", "yes"],
            ...
            {
                "inputs": [str(random.randint(-70, 39)), "nah", "yes", "yes"],
                "expected": "Good job staying dry!",
            },
            {
                "inputs": [str(random.randint(-70, 39)), "nope", "yes", "yes"],
                "expected": "Good job staying dry!",
            },
        ]
        self.run_tests(weather_helper, cases, capsys, monkeypatch)
